...
import com.example.bulletin.answer.AnswerForm;
...
//    @ResponseBody
    ...
    public String questoinModify(QuestionForm questionForm, @PathVariable("id") Integer id, Principal principal) throws DataNotFoundException {
        Question question = this.questionService.getQuestion(id);
